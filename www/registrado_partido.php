<?php
    ...
    $token_activation = party_register();
...
?>
    ...
    <section class="post">
        ...
        <a style="color: red" href="<?php echo getPage('party_activation') . '?token=' . $token_activation; ?>">
            <?php echo getPage('party_activation') . '?token=' . $token_activation; ?>
        </a>
    </section>
